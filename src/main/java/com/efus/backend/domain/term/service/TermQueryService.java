...
public class TermQueryService {
    ...
    public TermDetailResponse getTermDetail(Long termId) {
        ...
        // TODO 2. 권한 검증: 사용자가 '이 기수' 또는 '이 기수가 속한 단체의 다른 기수'에 가입한 이력이 있는지 확인
        // (가입 이력이 아예 없으면 403 TERM_ACCESS_DENIED)

        // TODO 3. 기수 구성원 수(memberCount) 집계

        // TODO 4. 로그인 사용자가 '현재 조회 중인 기수'에 직접 가입했는지 확인
        // - 가입했다면 myTermMemberId, myRole 세팅
        // - 가입하지 않고 다른 기수에만 가입한 상태라면 null 세팅
